...
from app import DATABASE, GENDERS, RELATIONSHIP_TYPES, SEEKING_OPTIONS, init_db

DEMO_PASSWORD = "demo12345"

# username, name, age, gender, location, relationship_type, interests,
# hobbies, seeking, age_min, age_max
DEMO_MEMBERS = [
    ("mia_b",      "Mia",     24, "Woman",      "Berlin",    "Long-term relationship",
     "music, travel, cooking", "salsa, yoga",          "Men",      21, 32),
    ("liam_k",     "Liam",    27, "Man",        "Berlin",    "Long-term relationship",
     "music, cooking, films",  "guitar, running",      "Women",    22, 30),
    ("noor_a",     "Noor",    22, "Woman",      "Hamburg",   "Casual dating",
     "art, photography",       "painting, cycling",    "Everyone", 18, 28),
    ("theo_r",     "Theo",    31, "Man",        "Munich",    "Marriage",
     "hiking, cooking, wine",  "climbing, chess",      "Women",    25, 36),
    ("ava_s",      "Ava",     29, "Woman",      "Munich",    "Marriage",
     "wine, travel, cooking",  "tennis, baking",       "Men",      27, 40),
    ("jonas_w",    "Jonas",   25, "Man",        "Berlin",    "Short-term relationship",
     "techno, gaming",         "skateboarding",        "Women",    19, 28),
    ("lena_h",     "Lena",    26, "Woman",      "Cologne",   "Friendship",
     "books, board games",     "knitting, hiking",     "Everyone", 20, 35),
    ("sam_v",      "Sam",     28, "Non-binary", "Berlin",    "Casual dating",
     "music, poetry, films",   "djing, swimming",      "Everyone", 21, 34),
    ("elias_m",    "Elias",   34, "Man",        "Frankfurt", "Long-term relationship",
     "cooking, travel, jazz",  "cycling, pottery",     "Women",    27, 38),
    ("clara_p",    "Clara",   33, "Woman",      "Frankfurt", "Long-term relationship",
     "jazz, cooking, museums", "pottery, running",     "Men",      29, 42),
    ("finn_d",     "Finn",    21, "Man",        "Leipzig",   "Casual dating",
     "gaming, football",       "fifa, gym",            "Women",    18, 25),
    ("zoe_t",      "Zoe",     20, "Woman",      "Leipzig",   "Casual dating",
     "football, festivals",    "gym, dancing",         "Men",      18, 26),
    ("omar_f",     "Omar",    30, "Man",        "Berlin",    "Long-term relationship",
     "travel, food, languages","surfing, cooking",     "Everyone", 24, 36),
    ("hana_y",     "Hana",    27, "Woman",      "Berlin",    "Long-term relationship",
     "languages, food, travel","climbing, cooking",    "Men",      25, 35),
    ("bruno_c",    "Bruno",   38, "Man",        "Stuttgart", "Not sure yet",
     "cars, cycling",          "motorsport, grilling", "Women",    30, 45),
    ("ines_l",     "Ines",    41, "Woman",      "Stuttgart", "Not sure yet",
     "cycling, gardening",     "grilling, reading",    "Men",      35, 50),
    ("kai_n",      "Kai",     23, "Man",        "Dresden",   "Friendship",
     "board games, anime",     "drawing, badminton",   "Everyone", 18, 30),
    ("robin_e",    "Robin",   25, "Non-binary", "Dresden",   "Friendship",
     "anime, board games",     "drawing, hiking",      "Everyone", 20, 32),
    ("stefan_g",   "Stefan",  36, "Man",        "Hamburg",   "Short-term relationship",
     "sailing, whisky",        "sailing, guitar",      "Women",    28, 42),
    ("paula_o",    "Paula",   32, "Woman",      "Hamburg",   "Short-term relationship",
     "whisky, sailing, films", "guitar, yoga",         "Men",      28, 40),
]
...
def validate():
    ...
    for row in DEMO_MEMBERS:
        _, name, _, gender, _, rel, _, _, seeking, lo, hi = row
...
def seed(db):
    ...
    for (
        ...
        interests, hobbies, seeking, age_min, age_max,
    ) in DEMO_MEMBERS:
        row = db.execute(
